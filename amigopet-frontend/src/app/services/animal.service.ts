...
export class AnimalService {
  ...
  listarAnimais(): Observable<any> {
    return this.http.get(
      'http://localhost:8080/animal/lista',
      this.getAuthHeaders()
    );
  }
  ...
  salvarAnimal(animal: Animal) {
    return this.http.post(
      'http://localhost:8080/animal/cadastrar',
      animal,
      this.getAuthHeaders()
    );
  }
  ...
  getAnimalById(id: number) {
    return this.http.get(
      'http://localhost:8080/animal/visualizar/' + id,
      this.getAuthHeaders()
    );
  }
  ...
  getAnimalByUser(id: string): Observable<any> {
    return this.http.get(
      'http://localhost:8080/animal/listarporusuario/' + id,
      this.getAuthHeaders()
    );
  }
  ...
  editarAnimalById(animal: Animal) {
    return this.http.put(
      'http://localhost:8080/animal/alterar/' + animal.id,
      animal,
      this.getAuthHeaders()
    );
  }
  ...
  listaAnimalByStatus(status: string, id: string): Observable<any> {
    return this.http.get(
      'http://localhost:8080/animal/listarporStatus/' + id + '/' + status,
      this.getAuthHeaders()
    );
  }
  ...
  filtarAnimal(animal: Animal) {
    return this.http.post(
      'http://localhost:8080/animal/listarcomfiltro',
      animal,
      this.getAuthHeaders()
    );
  }
